...
const i18n = {
    ru: {
        ...
        fleet_nodes_title: "Подключенные компьютеры и рабочие станции",
        fleet_nodes_subtitle: "Устройства сети, на которых настроена синхронизация контекста",
        fleet_sessions_title: "Активные MCP-сессии (Live Sessions)",
        fleet_sessions_subtitle: "Клиенты, обращающиеся к API или держащие SSE-поток",
    ...
    en: {
        ...
        fleet_nodes_title: "Connected Workstations & Machines",
        fleet_nodes_subtitle: "Network devices with context sync configured",
        fleet_sessions_title: "Active MCP Sessions (Live)",
        fleet_sessions_subtitle: "Clients connected in real-time or streaming over HTTP",
        btn_refresh: "Refresh",
